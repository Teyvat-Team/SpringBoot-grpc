...
public final class DataSourceServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.wr.grpc.lib.ListRequest,
      com.wr.grpc.lib.ListResponse> getListMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "List",
      requestType = com.wr.grpc.lib.ListRequest.class,
      responseType = com.wr.grpc.lib.ListResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.wr.grpc.lib.ListRequest,
      com.wr.grpc.lib.ListResponse> getListMethod() {
    io.grpc.MethodDescriptor<com.wr.grpc.lib.ListRequest, com.wr.grpc.lib.ListResponse> getListMethod;
      ...
      synchronized (DataSourceServiceGrpc.class) {
        if ((getListMethod = DataSourceServiceGrpc.getListMethod) == null) {
          DataSourceServiceGrpc.getListMethod = getListMethod =
              io.grpc.MethodDescriptor.<com.wr.grpc.lib.ListRequest, com.wr.grpc.lib.ListResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "List"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.wr.grpc.lib.ListRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.wr.grpc.lib.ListResponse.getDefaultInstance()))
  ...
  public static abstract class DataSourceServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void list(com.wr.grpc.lib.ListRequest request,
        io.grpc.stub.StreamObserver<com.wr.grpc.lib.ListResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.wr.grpc.lib.ListRequest,
                com.wr.grpc.lib.ListResponse>(
                  this, METHODID_LIST)))
          .build();
    }
  }
  ...
  public static final class DataSourceServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<DataSourceServiceBlockingStub> {
    ...
    /**
     */
    public com.wr.grpc.lib.ListResponse list(com.wr.grpc.lib.ListRequest request) {
  ...
  public static final class DataSourceServiceFutureStub extends io.grpc.stub.AbstractFutureStub<DataSourceServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.wr.grpc.lib.ListResponse> list(
        com.wr.grpc.lib.ListRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST:
          serviceImpl.list((com.wr.grpc.lib.ListRequest) request,
              (io.grpc.stub.StreamObserver<com.wr.grpc.lib.ListResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class DataSourceServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.wr.grpc.lib.DataSourceInfo.getDescriptor();
    }
